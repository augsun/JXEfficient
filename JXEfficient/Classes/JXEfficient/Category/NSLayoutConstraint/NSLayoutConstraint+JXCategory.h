...
/**
 ...
 @return 返回该约束的实例
 */
- (NSLayoutConstraint *)jx_con_same:(NSLayoutAttribute)att equal:(nullable id)view2 m:(CGFloat)m c:(CGFloat)c p:(UILayoutPriority)p;
...
/**
 ...
 @return 返回该约束的实例
 */
- (NSLayoutConstraint *)jx_con_same:(NSLayoutAttribute)att lessEqual:(nullable id)view2 m:(CGFloat)m c:(CGFloat)c p:(UILayoutPriority)p;
...
/**
 ...
 @return 返回该约束的实例
 */
- (NSLayoutConstraint *)jx_con_same:(NSLayoutAttribute)att greaterEqual:(nullable id)view2 m:(CGFloat)m c:(CGFloat)c p:(UILayoutPriority)p;
...
/**
 ...
 @return 返回该约束的实例
 */
- (NSLayoutConstraint *)jx_con_diff:(NSLayoutAttribute)att equal:(nullable id)view2 att2:(NSLayoutAttribute)att2 m:(CGFloat)m c:(CGFloat)c p:(UILayoutPriority)p;
...
/**
 ...
 @return 返回该约束的实例
 */
- (NSLayoutConstraint *)jx_con_diff:(NSLayoutAttribute)att lessEqual:(nullable id)view2 att2:(NSLayoutAttribute)att2 m:(CGFloat)m c:(CGFloat)c p:(UILayoutPriority)p;
...
/**
 ...
 @return 返回该约束的实例
 */
- (NSLayoutConstraint *)jx_con_diff:(NSLayoutAttribute)att greaterEqual:(nullable id)view2 att2:(NSLayoutAttribute)att2 m:(CGFloat)m c:(CGFloat)c p:(UILayoutPriority)p;
